		...
		<div class="container-login100" style="background: -webkit-linear-gradient(left, #fff066, orange);"> <!-- 뒷배경 -->
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				<br><br>
					...
					<%-- UserController2, UserBean2 --%>
					<form:form action="${root }member/login_load" modelAttribute="tempLoginUserBeanT" method="post">
					...
					<div class="txt1 text-center p-t-54 p-b-20">
						...
						<input type="checkbox" title="아이디 저장" tabindex="4" 
						v-model="isCheckedSaveId"> 아이디 저장<i></i>
						<p>	
						<br>
							
						<a href="${root }member/signup" class="txt2">
							Sign Up　
						</a>
						
						<a href="${root }member/searchID" class="txt2"
						id="#Modal-1" data-toggle="modal" data-target="#popup_box">
							Search ID　 
						</a>
						
						<a href="${root }member/searchPW" class="txt2"
						id="#Modal-2" data-toggle="modal" data-target="#popup_box2">
							Search PW　 
						</a>
								...
								<button type="button" class="close" data-dismiss="modal">&times;</button>
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-default"
											data-dismiss="modal" style="position: center;">Close</button>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="modal fade" id="popup_box2">
					...
					<div class="flex-col-c p-t-155">
						...
						<a href="${root }views/signup" class="txt2">
							Sign Up
						</a>
					</div>
 					-->
