...
<body oncontextmenu='return false' class='snippet-body'>
   ...
   <form action="${root}board/write_pro" method="post" enctype="multipart/form-data" onsubmit="return formCheck(this)">
      ...
      <div class="container register mb-5">
         <div class="row">
            <div class="col-md-3 register-left">
               ...
               <%--  <form:button class="btn btn-primary aa3 mb-3" type="submit" name="" role="tab">글 등록</form:button> --%>
                <input type="submit" class="btn btn-primary aa3 mb-3" type="submit" name="" role="tab">글 등록 제출 대체 머임
                <a class="btn btn-primary aa3 mb-3" href="${root }board/boardList" role="tab">취소</a>
            </div>
            <div class="col-lg-9 register-right hb">
               ...
               <div class="tab-content" id="myTabContent">
                     ...
                     <div class="row register-form">
                        <div class="col-md-6">
                           <div class="form-group">
                              <select class="form-control" id="category" name="board_category" required>
                                 <option class="hidden" value="" selected disabled>구분</option>
                                 <option value="실종">실종</option>
                                 <option value="보호">보호</option>
                                 <option value="보호요청">보호요청</option>
                           ...
                           <div class="form-group ">
                              <div class="input-group date">
                                 <input type="text" name="happen_date" class="form-control" id='datepicker' />
                                 <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                              </div>
                           </div>
                           <div class="form-group">
                              <input type="text" name="writer_phone" minlength="10" maxlength="11" class="form-control" placeholder="연락받을번호 *" value="" required />
                           </div>
                           <div class="form-group">
                        ...
                        <div class="col-md-6">
                        <div class="form-group">
                              <input type="text" class="form-control" name="address1"  id="sample5_address" placeholder="주소" style="position: relative;" readonly required  />
                           </div>
                           <div class="form-group">
                  ...
                  <div class="tab-pane fade show pt-5" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                     <h3 class="register-heading ha">강아지 정보</h3>
                     <div class="row register-form">
                        <div class="col-md-6">
                           <div class="form-group">
                              <select name="breed" class="form-control" required>
                                 <option class="hidden" value="" selected disabled>품종 선택</option>
                           ...
                           <div class="age_weight">
                              <div class="form-group">
                                 <select class="form-control mm" name="age" required>
                                    <option class="hidden" value="" selected disabled>나이 선택</option>
                                    <option value="나이 모름">나이 모름</option>
                              ...
                              <div>
                                 <select class="form-control mn" name="weight" required>
                                    <option class="hidden" value="" selected disabled>몸무게 선택</option>
                                    <option value="몸무게 모름">몸무게 모름</option>
                           ...
                           <div class="form-group">
                              <div class="maxl">
                                 ...
                                 <label class="radio inline">
                                    <input type="radio" name="sex" checked='true' value="수컷" />
                                    <span>&nbsp;수컷 </span>&nbsp;&nbsp;&nbsp;&nbsp;
                                 </label>
                                 <label class="radio inline">
                                    <input type="radio" name="sex" value="암컷" />
                                    <span>&nbsp;암컷 </span>&nbsp;&nbsp;&nbsp;&nbsp;
                                 </label>
                                 <label class="radio inline">
                                    <input type="radio" name="sex" value="미확인" />
                                    <span>&nbsp;미확인 </span>
                                 </label>
                              </div>
                           </div>
                           <div class="form-group">
                              <div class="maxl">
                                 <label class="radio inline">
                                    <input type="checkbox" name="neutering" value="false" id="neutering" />
                                    <span>중성화</span>
                                 </label>
                                 <label class="radio inline cc">
                                    <input type="checkbox" id="chip_num_ck" name="chip_num_ck" value="" />
                                    <span>칩셋 보유</span>
                                 </label>
                            <div class="form-group chipDiv">
                              <input type='text' class='form-control rfid mb-3' id='chip_num' name='chip_num' onkeypress="resetIdExist()" minlength="15" maxlength="15" placeholder='칩셋번호입력' />
                              <input type='text' name='dog_name' class='form-control rfid mb-3' id='dog_name' placeholder='강아지이름' />
                              <input type='text' name='phone' class='form-control rfid mb-3' minlength="10" maxlength="11" placeholder='주인연락처' />
                              <button type="button" class="form-control btn btn-primary rfid aa4" onclick="checkRFID()">중복확인</button>
                              <input type="hidden" id='chip_ck' value='0'/>
                           </div>        
                           <div class="form-group">
                              <input type="text" class="form-control" placeholder="털색" name="color" required />
                           </div>
                           <div class="form-group">
                              <input type="text" class="form-control" placeholder="특징" name="charcteristic" required />
                           </div>
                           <div class="form-group">
                              <textarea rows="4" cols="37" class="form-control" placeholder="상세내용" style="resize:none;" name="dog_content"></textarea>
                           </div>
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                              <input class="upload-box upload-plus" type="file" id="dog_img" name="originFile" accept="image/*" required />
            ...
            oncomplete : function(data) {
               ...
               geocoder.addressSearch(data.address, function(results,
                  ...
                  if (status === daum.maps.services.Status.OK) {
                     ...
                     console.log("주소에요 "+result.y, result.x);
                  }
               });
            }
         }).open();
