...
<head>
	...
	<script type="text/javascript" nonce="b53b0a014ba94d4a9d21a20025b" src="//local.adguard.org?ts=1647676406029&amp;type=content-script&amp;dmn=www.bootdey.com&amp;pth=%2Fsnippets%2Fexecute_download%2Ft3&amp;app=msedge.exe&amp;css=3&amp;js=1&amp;rel=1&amp;rji=1&amp;sbe=1&amp;stealth=1&amp;uag="></script>
	<script type="text/javascript" nonce="b53b0a014ba94d4a9d21a20025b" src="//local.adguard.org?ts=1647676406029&amp;name=AdGuard%20Extra&amp;name=AdGuard%20Popup%20Blocker&amp;type=user-script"></script><script src="https://code.jquery.com/jquery-1.10.2.min.js"></script>
        ...
        <div class="user-dashboard-info-box table-responsive mb-0 bg-white p-4 shadow-sm">
          <table class="table manage-candidates-top mb-0">
            <thead>
              <tr>
                <th>
                	<label><input type="radio" name='category' value="전체" checked>전체</label>
                	<label><input type="radio" name='category' value="실종">실종</label>
                	<label><input type="radio" name='category' value="보호">보호</label>
                	<label><input type="radio" name='category' value="보호요청">보호요청</label>
                	<label><input type="radio" name='category' value="목격">목격</label>
                	<label><input type="radio" name='category' value="완료">완료</label>
                </th>
            ...
            <c:forEach var="item" items="${list }">
              <tr class="candidates-list">
                ...
                <td class="candidate-list-favourite-time text-center">
                  ...
                  <span class="candidate-list-time order-1">좋아요 ${item.likecount}</span>
