               ...
               <div class="tab-content" id="myTabContent">
                  <div class="tab-pane fade show active pt-5" id="home" role="tabpanel" aria-form:labelledby="home-tab">
                     ...
                     <div class="row register-form">
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                              <form:input type="text" path="board.writer_phone" minlength="10" maxlength="11" name="txtEmpPhone" class="form-control" placeholder="연락받을번호 *" value="" required='true' />
                           </div>
                           <div class="form-group">
                        ...
                        <div class="col-md-6">
                        <div class="form-group">
                              <form:input type="text" class="form-control" path="dog.address1" name="address1" id="sample5_address" placeholder="주소" style="position: relative;" readonly="true" required='required' />
                           </div>
                           <div class="form-group">
                              <form:input type="text" class="form-control" path="dog.address2" name="address2" placeholder="상세주소" />
                           </div>
                           <div class="form-group">
                  ...
                  <div class="tab-pane fade show pt-5" id="profile" role="tabpanel" aria-form:labelledby="profile-tab">
                     ...
                     <div class="row register-form">
                        <div class="col-md-6">
                           ...
                           <div class="form-group">
                              <div class="maxl">
                                 ...
                                 <form:label class="radio inline" path="dog.sex">
                                    <form:radiobutton path="dog.sex" checked='true' value="수컷" />
                                    <span>&nbsp;수컷 </span>&nbsp;&nbsp;&nbsp;&nbsp;
                                 </form:label>
                                 <form:label class="radio inline" path="dog.sex">
                                    <form:radiobutton path="dog.sex" value="암컷" />
                                    <span>&nbsp;암컷 </span>&nbsp;&nbsp;&nbsp;&nbsp;
                                 </form:label>
                                 <form:label class="radio inline" path="dog.sex">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group chipDiv">
                              <form:input type='text' class='form-control rfid mb-3' id='chip_num' path='chip.chip_num' onkeypress="resetIdExist()" minlength="15" maxlength="15" placeholder='칩셋번호입력' />
                              <form:input type='text' path='chip.dog_name' class='form-control rfid mb-3' id='dog_name' placeholder='강아지이름' />
                              <form:input type='text' path='chip.phone' class='form-control rfid mb-3' minlength="10" maxlength="11" placeholder='주인연락처' />
                           ...
                           <div class="form-group">
                              <form:input type="text" class="form-control" placeholder="털색" path="dog.color" required='true' />
                           </div>
                           <div class="form-group">
                              <form:input type="text" class="form-control" placeholder="특징" path="dog.charcteristic" required='true' />
                           </div>
                           <div class="form-group">
                              <form:textarea rows="4" cols="37" class="form-control" placeholder="상세내용" style="resize:none;" path="dog.dog_content" />
                           </div>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              <form:label path="dog.dog_img">첨부 이미지</form:label>
