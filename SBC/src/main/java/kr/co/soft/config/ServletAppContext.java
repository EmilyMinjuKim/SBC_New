...
public class ServletAppContext implements WebMvcConfigurer{
    ...
    @Bean
    public MapperFactoryBean<ProductMapper> product_mapper(SqlSessionFactory factory) 
    		throws Exception{
    ...
    @Bean
    public MapperFactoryBean<OrderMapper> order_mapper(SqlSessionFactory factory) 
    		throws Exception{
